...
/**
 * swiper 轮播组件
 * @param params 默认全部 false
 * @param params.el 组件节点 class|id|<label>
 * @param params.moveTime 过渡时间（毫秒）默认 300
 * @param params.interval 自动播放间隔（毫秒）默认 3000
 * @param params.loop 是否需要回路
 * @param params.vertical 是否垂直滚动
